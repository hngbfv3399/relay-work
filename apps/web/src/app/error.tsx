  ...
  return (
    <main className="grid min-h-dvh place-items-center bg-[#f8fafc] p-5">
      <section className="max-w-md text-center">
        <span className="mx-auto grid size-16 place-items-center rounded-3xl bg-rose-50 text-rose-600">
          <TriangleAlert className="size-8" />
        </span>
        <h1 className="mt-6 text-2xl font-bold">화면을 불러오지 못했어요.</h1>
        <p className="mt-3 text-sm leading-6 text-slate-500">
          잠시 후 다시 시도해주세요. 문제가 계속되면 팀 관리자에게 알려주세요.
        </p>
        <button
          onClick={reset}
